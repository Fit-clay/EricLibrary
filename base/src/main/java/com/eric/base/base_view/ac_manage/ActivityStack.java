package com.eric.base.base_view.ac_manage;
...
public class ActivityStack {
    ...
    /**
     * finish除了制定activity之外的所有activities
     * @param actCls
     */
    public void findActivityExceptClass(Class<? extends Activity> actCls) {
        Activity aActivity = null;
        Iterator<Activity> itr = mActicityStack.iterator();
        while (itr.hasNext()) {
            aActivity = itr.next();
    ...
    public void clearActivity(Class cls){
        if(findActivityByClass(cls)!=null){
            finishActivity(cls);
        }
    }
