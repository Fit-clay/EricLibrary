...
public class SPUtils
{
	...
	public  static <T> T getObject(Context context,String key, Class clas){
		SharedPreferences sp = context.getSharedPreferences(FILE_NAME,
				Context.MODE_PRIVATE);
		return  (T)JsonUtils.parseObject(sp.getString(key,""),clas);
	}
	/**
	 * 移除某个key值已经对应的值
	 *
	...
	public static <T> T getBean(Context context,String key, Class<T> cls){
		...
		return JsonUtils.parseObject(str,cls);
	}
